...
android_manifest = ".repo/manifests/snippets/aurora.xml"
...
custom_local_manifest = ".repo/local_manifests/aurora_manifest.xml"
custom_default_revision = "14"
custom_dependencies = "aurora.dependencies"
org_manifest = "aurora-devices"  # leave empty if org is provided in manifest
org_display = "aurora-Devices"  # needed for displaying
